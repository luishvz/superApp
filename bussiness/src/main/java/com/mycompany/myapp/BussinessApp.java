...
public class BussinessApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(BussinessApp.class);

    @Inject
    private Environment env;

    /**
     * Initializes bussiness.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BussinessApp.class);
