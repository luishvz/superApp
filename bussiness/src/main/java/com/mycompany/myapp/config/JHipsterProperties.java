...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "bussiness@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "bussiness API";

        private String description = "bussiness API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "bussiness";
