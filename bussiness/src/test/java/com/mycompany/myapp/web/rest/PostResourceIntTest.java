...
import com.mycompany.myapp.BussinessApp;
...
@SpringBootTest(classes = {BussinessApp.class, SecurityBeanOverrideConfiguration.class})
public class PostResourceIntTest {
    ...
    public void createPostWithExistingId() throws Exception {
        ...
        PostDTO existingPostDTO = postMapper.postToPostDTO(existingPost);

        // An entity with an existing ID cannot be created, so this API call must fail
        restPostMockMvc.perform(post("/api/posts")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(existingPostDTO)))
