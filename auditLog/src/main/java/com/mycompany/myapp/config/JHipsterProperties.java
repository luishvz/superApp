...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "auditLog@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "auditLog API";

        private String description = "auditLog API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "auditLog";
